...
sudo_rq
zenwrn $"This script requires Lossless Scaling for Windows to be installed on your system through Steam, Lutris or Bottles. Please make sure it is installed before proceeding."
