...
# NAME: Install GIMP
# VERSION: 2.10
# DESCRIPTION: Installs the GIMP image editor using the system's package manager. Requires admin privileges.
# ICON: image-x-generic

# --- Start of the script code ---
flatpak_in_lib
flatpak install --user --noninteractive org.gimp.GIMP
