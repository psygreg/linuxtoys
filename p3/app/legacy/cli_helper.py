...
def install_package(package_name):
    ...
    try:
        ...
        # Legacy runtime is in app/legacy/, so we need to go up two levels to reach p3/libs
        lib_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'libs', 'linuxtoys.lib')
