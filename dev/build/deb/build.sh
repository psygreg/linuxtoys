...
cp -rf "$ROOT_DIR/p3"/* linuxtoys_$lt_version.orig/usr/share/linuxtoys/
...
cp "$ROOT_DIR/src/LinuxToys.desktop" linuxtoys_$lt_version.orig/usr/share/applications/
cp "$ROOT_DIR/src/linuxtoys.svg" linuxtoys_$lt_version.orig/usr/share/icons/hicolor/scalable/apps/
