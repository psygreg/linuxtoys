...
Requires:       bash git curl wget zenity appstream appstream-data python3 python3-gobject gtk3 python3-requests python3-urllib3 python3-certifi vte291 (sudo or sudo-rs)
...
%changelog
* Sat Sep 19 2026 Victor Gregory <psygreg@pm.me> - 7.2.2
